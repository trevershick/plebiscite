...
public class DynamoDbBallot implements Ballot {
	...
	@DynamoDBAttribute(attributeName="ClosePolicies")
	@DynamoDBMarshalling(marshallerClass=PolicyMarshaller.class)
	public Collection<BallotClosePolicy> getClosePolicies() {
		return this.policies;
	}
	public void setClosePolicies(Collection<BallotClosePolicy> pols) {
		this.policies.clear();
		this.policies.addAll(pols);
	}
	@DynamoDBIgnore
	public boolean isComplete() {
		throw new RuntimeException("canClose not yet implemented");
	}
	@DynamoDBIgnore
	public Collection<User> getRequiredVoters() {
		throw new RuntimeException("getRequiredVoters not yet implemented");
	}

	@DynamoDBIgnore
	public void addClosePolicy(BallotClosePolicy bcp) {
		this.policies.add(bcp);
	}
